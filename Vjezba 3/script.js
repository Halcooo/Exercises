...
function displayBlog() {
  ...
  for (var blog of allBlogs) {
      ...
      var trazi = document.getElementById("blogSearch").value;
      
      if (blog.blogTitle.toUpperCase().includes(trazi.toUpperCase()) || blog.blogDesc.toUpperCase().includes(trazi.toUpperCase())) {
